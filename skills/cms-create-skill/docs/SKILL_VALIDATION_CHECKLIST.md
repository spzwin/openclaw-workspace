...
- [ ] 目标 `SKILL.md` 明确引用 `cms-auth-skills/common/conventions.md` 与 `cms-auth-skills/common/auth.md`
- [ ] 目标 `SKILL.md` 包含"授权依赖"安装指引（cms-auth-skills 的检查与安装说明，含 `npx clawhub@latest install` 命令）
